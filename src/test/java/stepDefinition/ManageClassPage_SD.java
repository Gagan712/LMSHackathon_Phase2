...
public class ManageClassPage_SD {
	...
	@Then("Admin should see all the {string} and the correct spelling")
	public void admin_should_see_all_the_batch_id_and_the_correct_spelling() {
	...
	@Then("Admin should see the text as {string} below the table above the footer")
	public void admin_should_see_the_text_as_below_the_table_above_the_footer(String string) {
